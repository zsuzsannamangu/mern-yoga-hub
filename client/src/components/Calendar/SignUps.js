...
import { getRecaptchaToken } from '../../utils/recaptcha'; // ✅ New
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const recaptchaToken = await getRecaptchaToken('signup_form_submit'); // ✅ Centralized token
      ...
      <form className="signup-form" onSubmit={handleSubmit}>
        ...
        <label className="waiver">
          <p readOnly className="waiver-text">
            ...
            I understand that the yoga classes and events offered by Zsuzsanna Mangu...
          </p>
        </label>
        ...
        <div className="signature-section">
          ...
          <button type="button" onClick={handleSignatureSave}>Save</button>
        </div>
