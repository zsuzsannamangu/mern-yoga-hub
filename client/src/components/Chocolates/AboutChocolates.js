    ...
    <div className="about-chocolates-section">
      <div className="about-chocolates-content">
        <motion.div className="about-chocolates-text" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <p>
            ReTreat Chocolates is my Portland-based line of small-batch, plant-based chocolate — including maple-sweetened{' '}
            <strong>dark chocolate made in Portland</strong>
            — sold here on Yoga and Chocolate and through local pickup. Every batch is made with organic or ceremonial cacao.
            I&apos;m Zsuzsanna Mangu; I&apos;ve run this business since November 2020.
          </p>
      ...
      <div className="about-chocolates-content-2">
        <motion.div className="about-chocolates-image-2" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <img src="/images/chocolates/Addtotin.jpg" alt="Zsuzsi" />
          <p className="photo-credit">Photo by Jason Quigley</p>
        </motion.div>
        <motion.div className="about-chocolates-text" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <p>If you loved your chocolates, please mention it on Instagram and tag me at <strong><a href="https://www.instagram.com/zsuzsannacreates/">@zsuzsannacreates</a></strong>, and receive 15% off your next order. If I missed your story, please let me know!</p>
        </motion.div>
      </div>
      <div className="about-chocolates-content">
        <motion.div className="about-chocolates-text" variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <p>Prices start at $520 for a 2-hour event serving 20 people, and include four pieces of handcrafted chocolate per person - each one a different flavor. 
            I personally serve the chocolates and guide your guests through the tasting experience.</p>
