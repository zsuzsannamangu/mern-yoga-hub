...
const offeringsData = [
    ...
    },
    {
        ...
        As a collaborative journey, therapeutic yoga provides space to explore tools such as mindful yoga postures, restorative breath exercises, and grounding visualizations. These elements are carefully tailored to support you in nurturing your body’s innate wisdom and ease.<br><br>
