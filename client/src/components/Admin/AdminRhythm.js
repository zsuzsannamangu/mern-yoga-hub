...
import { createDefaultRhythmDocument, rid } from './adminRhythmDefaults';
        ...
        <AdminLayout>
            <div className="admin-rhythm">
                ...
                {doc.sections.map((section) => (
                    <section key={section.id} className="admin-rhythm__section">
                        <div className="admin-rhythm__section-head">
                            ...
                            <div className="admin-rhythm__section-actions">
                                ...
                                <button
                                    type="button"
                                    className="admin-rhythm__icon-btn"
                            ...
                            <table className="admin-rhythm__table">
                                ...
                                <tbody>
                                    {section.rows.length === 0 ? (
                                        <tr>
                                            <td colSpan={section.columns.length + 1} style={{ color: '#5a6c7d', fontStyle: 'italic' }}>
                                                ...
                                                {section.columns.map((_, ci) => (
                                                    <td key={ci}>
                                                        <input
                                                            ...
                                                            value={row.cells[ci] ?? ''}
                                                            onChange={(e) => setCell(section.id, row.id, ci, e.target.value)}
                                                        />
                                                    </td>
                                                ))}
