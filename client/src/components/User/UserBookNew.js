    ...
    return (
        <div className="user-page">
            <div className="user-content">
                <h3 className="section-title">Book a Virtual Session</h3>
            ...
            <div className="pricing-info">
                ...
                <p> Individualized yoga therapy sessions: Online sessions are $10-$80/hr sliding scale, and in-person sessions in NW Portland are $20-$100/hr sliding scale. Please note that online booking is only available for virtual sessions. For in-person sessions please contact me directly.</p>
